...
public class SystemMenuDAOImpl extends GenericDAOIbatisImpl<HashMap> implements SystemMenuDAO
	{
		private static final Logger logger = Logger.getLogger(SystemMenuDAOImpl.class);

		private static String IBATIS_NS_PREFIX = "system_menu.";
