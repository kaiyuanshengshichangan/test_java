package com.ck.platform.business.system.dao.impl;
...
public class SystemUserDAOImpl extends GenericDAOIbatisImpl<HashMap> implements SystemUserDAO
	{
		private static final Logger logger = Logger.getLogger(SystemUserDAOImpl.class);

		private static String IBATIS_NS_PREFIX = "system_user.";
