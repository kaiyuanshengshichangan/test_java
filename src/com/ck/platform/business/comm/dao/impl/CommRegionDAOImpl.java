...
@Repository("commRegionDAO")
public class CommRegionDAOImpl extends GenericDAOIbatisImpl<HashMap> implements CommRegionDAO
	{
		private static final Logger logger = Logger.getLogger(CommRegionDAOImpl.class);

		private static String IBATIS_NS_PREFIX = "comm_region.";
