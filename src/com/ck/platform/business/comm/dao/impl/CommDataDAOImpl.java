...
@Repository("commDataDAO")
public class CommDataDAOImpl extends GenericDAOIbatisImpl<HashMap> implements CommDataDAO
	{
		private static final Logger logger = Logger.getLogger(CommDataDAOImpl.class);

		private static String IBATIS_NS_PREFIX = "comm_data.";
