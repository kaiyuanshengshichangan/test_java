...
@Repository("logOrderPaymentDAO")
public class LogOrderPaymentDAOImpl extends GenericDAOIbatisImpl<HashMap> implements LogOrderPaymentDAO
	{
		private static final Logger logger = Logger.getLogger(LogOrderPaymentDAOImpl.class);

		private static String IBATIS_NS_PREFIX = "log_order_payment.";
