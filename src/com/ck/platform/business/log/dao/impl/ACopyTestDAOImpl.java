...
@Repository("aCopyTestDAO")
public class ACopyTestDAOImpl extends GenericDAOIbatisImpl<HashMap> implements ACopyTestDAO
	{
		private static final Logger logger = Logger.getLogger(ACopyTestDAOImpl.class);

		private static String IBATIS_NS_PREFIX = "order_test.";
