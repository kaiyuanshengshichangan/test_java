...
import com.ck.platform.business.cms.dao.CmsColumnDAO;


@SuppressWarnings({ "rawtypes" })
@Repository("cmsColumnDAO")
public class CmsColumnDAOImpl extends GenericDAOIbatisImpl<HashMap> implements CmsColumnDAO
	{
		private static final Logger logger = Logger.getLogger(CmsColumnDAOImpl.class);
