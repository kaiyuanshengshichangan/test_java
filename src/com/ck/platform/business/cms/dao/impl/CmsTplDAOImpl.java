...
import com.ck.platform.business.cms.dao.CmsTplDAO;


@SuppressWarnings({ "rawtypes" })
@Repository("cmsTplDAO")
public class CmsTplDAOImpl extends GenericDAOIbatisImpl<HashMap> implements CmsTplDAO
	{
		private static final Logger logger = Logger.getLogger(CmsTplDAOImpl.class);

		private static String IBATIS_NS_PREFIX = "cms_column.";
