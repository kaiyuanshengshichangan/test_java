...
@Repository("customerUniteSocialDAO")
public class CustomerUniteSocialDAOImpl extends GenericDAOIbatisImpl<HashMap> implements CustomerUniteSocialDAO
	{
		private static final Logger logger = Logger.getLogger(CustomerUniteSocialDAOImpl.class);

		private static String IBATIS_NS_PREFIX = "customer_unite_social.";
