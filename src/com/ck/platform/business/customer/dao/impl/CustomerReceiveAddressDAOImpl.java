...
@Repository("customerReceiveAddressDAO")
public class CustomerReceiveAddressDAOImpl extends GenericDAOIbatisImpl<HashMap> implements CustomerReceiveAddressDAO
	{
		private static final Logger logger = Logger.getLogger(CustomerReceiveAddressDAOImpl.class);

		private static String IBATIS_NS_PREFIX = "customer_receive_address.";
