...
@Repository("customerUniteDAO")
public class CustomerUniteDAOImpl extends GenericDAOIbatisImpl<HashMap> implements CustomerUniteDAO
	{
		private static final Logger logger = Logger.getLogger(CustomerUniteDAOImpl.class);

		private static String IBATIS_NS_PREFIX = "customer_unite.";
