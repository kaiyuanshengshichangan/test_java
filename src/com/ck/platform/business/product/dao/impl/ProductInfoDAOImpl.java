...
public class ProductInfoDAOImpl extends GenericDAOIbatisImpl<HashMap> implements ProductInfoDAO
	{
		private static final Logger logger = Logger.getLogger(ProductInfoDAOImpl.class);

		private static String IBATIS_NS_PREFIX = "product_info.";
